  ...
  return (
    <>
      <div
        className={twMerge(
          clsx(
            'fixed inset-0 left-1/2 top-11 z-50 w-[396px] translate-x-[-50%] rounded-xl backdrop-blur-lg transition-opacity duration-300',
            {
      ...
      >
        ...
        <div className="modal-box flex flex-col">
          ...
          <CustomButton
            onClick={onSubmit}
            className="bg-button_accent hover:from-button_hover_l hover:to-button_hover_r border-none px-8 py-4 outline-transparent transition-all delay-300 duration-300 ease-linear hover:bg-gradient-to-r hover:delay-300"
          >
            {submitButtonText}
          </CustomButton>
