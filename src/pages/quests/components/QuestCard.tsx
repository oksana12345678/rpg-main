...
const QuestCard: React.FC<QuestCardProps> = ({ quest }) => {
  ...
  const handleDetailsClick = () => {
    ...
    // Redirect to QuestDetails page with the correct quest id
  ...
  return (
    <div className="flex items-center rounded-lg bg-transparent p-3">
      ...
      <div className="ml-4 w-2/3">
        ...
        <div className="mt-2">
          <button
            className="button bg-button_accent mr-2 rounded-full px-3 py-1 text-[0.7rem] font-semibold text-white"
